...
setup_packages = [f"traductor_csv.{package}" for package in find_packages(where=os.path.join(os.path.dirname(__file__), 'src'))]
setup_packages.append("traductor_csv")
